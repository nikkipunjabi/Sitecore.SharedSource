        ...
        protected void btnGetReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkbxDescendant.Checked)
                {
                    ...
                    {
                        childItems = parent.Axes.GetDescendants().Where(i => i.Fields != null && i.Fields["__Renderings"] != null && i.Fields["__Renderings"].ToString() != string.Empty).OrderBy(x => x["__Updated"]).ToList();
                    }
                    else
                    {
                        childItems = parent.Axes.GetDescendants().Where(i => i.Fields != null && i.Fields["__Renderings"] != null && i.Fields["__Renderings"].ToString() != string.Empty).ToList();
                    }
                }
                else
                {
                    if (orderByDate.Checked)
                    {
                        childItems = parent.GetChildren().Where(i => i.Fields != null && i.Fields["__Renderings"] != null && i.Fields["__Renderings"].ToString() != string.Empty).OrderBy(x => x["__Updated"]).ToList();
                    }
                    else
                    {
                        childItems = parent.GetChildren().Where(i => i.Fields != null && i.Fields["__Renderings"] != null && i.Fields["__Renderings"].ToString() != string.Empty).ToList();
                    }
                }
